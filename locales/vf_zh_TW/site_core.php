...
$Definition['&laquo; hide previous quotes'] = '&laquo; 隱藏之前的引言';
$Definition['&raquo; show previous quotes'] = '&raquo; 顯示之前的引言';
...
$Definition['Hide previous quotes'] = '&laquo; 隱藏之前的引言';
...
$Definition['New Discussion'] = '發表文章';
...
$Definition['Page'] = '頁面';
$Definition['page'] = '頁';
$Definition['Page %1$s of %2$s'] = '%2$ 頁之 %1$';
$Definition['Page %s'] = '頁數 %';
...
$Definition['Paragraph Code Block'] = '段落代碼區塊';
...
$Definition['Progress on an idea you voted on!'] = '您所投的構想進度！';
...
$Definition['richEditor.menu.codeBlock'] = '代碼區塊';
...
$Definition['richEditor.menu.spoiler'] = '掃興警示';
...
$Definition['Show previous quotes'] = '&raquo; 顯示之前的引言';
...
$Definition['ValidateMinLength'] = '%1$s 是 %2$s 字元太短。';
$Definition['ValidateMinLengthPlural'] = '%1$s 是 %2$s 字元太短。';
$Definition['ValidateMinLengthSingular'] = '%1$s 是 %2$s 字元太短。';
...
$Definition['Voting for the idea is %s.'] = '這個構想的得票數是 %s。';
...
$Definition['You are about to ban {User.UserID,user}.'] = '您將被封鎖 {用戶、用戶名、用戶}。';
...
$Definition['You have posted %1$s times within %2$s seconds. A spam block is now in effect on your account. You must wait at least %3$s seconds before attempting to post again.'] = '您已經在 %2$s 秒內發貼 %1$s 次, 為防止惡意灌水, 請等待 %3$s 秒後再重新文章.';
